package com.nisovin.magicjutsus.volatilecode.v1_13_R2
...
class VolatileCode1_13_R2: VolatileCodeHandle {
    ...
    init {
        try {
            ...
            MagicJutsus.error("THIS OCCURRED WHEN CREATING THE VOLATILE CODE HANDLE FOR 1.13, THE FOLLOWING ERROR IS MOST LIKELY USEFUL IF YOU'RE RUNNING THE LATEST VERSION OF MAGICJUTSUS.")
            e.printStackTrace()
        }
    }
