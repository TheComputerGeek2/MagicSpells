package com.nisovin.magicjutsus.volatilecode.v1_15_R1
...
class VolatileCode1_15_R1: VolatileCodeHandle {
    ...
    init {
        try {
            ...
            MagicJutsus.error("THIS OCCURRED WHEN CREATING THE VOLATILE CODE HANDLE FOR 1.15, THE FOLLOWING ERROR IS MOST LIKELY USEFUL IF YOU'RE RUNNING THE LATEST VERSION OF MAGICJUTSUS.")
            e.printStackTrace()
        }
    }
