...
public class VariableMatchesCondition extends Condition {
	...
	public boolean check(LivingEntity livingEntity) {
		...
		return Objects.equals(
			MagicJutsus.getVariableManager().getStringValue(variable, (Player) livingEntity),
			MagicJutsus.getVariableManager().getStringValue(variable, (String) null)
		);
	}
	...
	public boolean check(LivingEntity livingEntity, LivingEntity target) {
		...
		return Objects.equals(
			MagicJutsus.getVariableManager().getStringValue(variable, (Player) livingEntity),
			MagicJutsus.getVariableManager().getStringValue(variable, target.getName())
		);
	}
