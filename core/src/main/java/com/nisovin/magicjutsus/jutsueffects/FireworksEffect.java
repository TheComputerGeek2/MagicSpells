...
public class FireworksEffect extends JutsuEffect implements Listener {
	...
	public Runnable playEffectLocation(Location location) {
		...
		firework.setMetadata("MSFirework", new FixedMetadataValue(MagicJutsus.getInstance(), "MSFirework"));
