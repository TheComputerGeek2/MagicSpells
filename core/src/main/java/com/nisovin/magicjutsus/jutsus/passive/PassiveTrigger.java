...
public class PassiveTrigger {
	...
	public static Set<PassiveTrigger> JUMP = addTriggers("jump", JumpListener.class);
	...
	public static Set<PassiveTrigger> JUTSU_CAST = addTriggers("jutsucast", JutsuCastListener.class);
	public static Set<PassiveTrigger> JUTSU_CASTED = addTriggers("jutsucasted", JutsuCastedListener.class);
	public static Set<PassiveTrigger> JUTSU_TARGET = addTriggers("jutsutarget", JutsuTargetListener.class);
	public static Set<PassiveTrigger> JUTSU_TARGETED = addTriggers("jutsutargeted", JutsuTargetedListener.class);
	...
	public PassiveListener getListener() {
		if (listener == null) {
			try {
				...
				MagicJutsus.registerEvents(listener, customPriority);
			} catch (Exception e) {
